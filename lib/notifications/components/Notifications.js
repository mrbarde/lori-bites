...
var Notifications = exports.Notifications = function (_Component) {
    ...
    _createClass(Notifications, [{
        ...
        value: function containerProps() {
            ...
            var props = {};
            // set styles
            props.style = Object.assign({}, styles.container, styles[this.props.position], this.props.style);
            // set classname
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return (0, _redux.bindActionCreators)({ pushEnd: _actions.pushEnd, removeEnd: _actions.removeEnd }, dispatch);
};
